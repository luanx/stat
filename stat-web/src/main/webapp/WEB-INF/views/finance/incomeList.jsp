...
<div class="row">
    <div class="col-sm-3 col-lg-2">
        <ul class="nav nav-pills nav-stacked nav-email">
            ...
            <li class="active"><a href="${lx}/finance/income"><i class="glyphicon glyphicon-star"></i> 收入情况</a></li>
            ...
            <div class="panel-body">
                ...
                <div id="custom-toolbar">
                    ...
                    <div class="btn-group mr10">
                        <a class="btn btn-default" href="${lx}/finance/income/create"><i class="fa fa-arrows mr5"></i> 添加</a>
                    </div>
...
<script>
    jQuery(document).ready(function () {
        ...
        var inputTable = jQuery("#inputTable").bootstrapTable({
            "url": "${lx}/api/v1/finance/income/" + organizationId,
            "method": "get",
            "striped": true,
            "sortOrder": "desc",
            "dataType": "json",
        ...
        jQuery("#organizationList").change(function () {
            ...
            inputTable.bootstrapTable('refresh', {url: "${lx}/api/v1/finance/income/" + organizationId});
        });
