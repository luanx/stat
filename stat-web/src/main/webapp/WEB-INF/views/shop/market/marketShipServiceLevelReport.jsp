...
<div class="row">
    <div class="col-sm-3 col-lg-2">
        <ul class="nav nav-pills nav-stacked nav-email">
            ...
            <li class="active"><a href="${lx}/market/report/shipservicelevel"><i class="glyphicon glyphicon-shopping-cart"></i>
                快递选择</a></li>
        </ul>
...
<script type="text/javascript">
    ...
    function init(startDate, endDate) {
        ...
        // ajax getting data
        $.ajax({
            "url": "${lx}/api/v1/market/report/shipservicelevel/" + organizationId,
            "method": "POST",
            "data": {
                startDate: startDate,
                endDate: endDate
