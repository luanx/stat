...
<div class="row">
    <div class="col-sm-3 col-lg-2">
        <ul class="nav nav-pills nav-stacked nav-email">
            <li><a href="${lx}/market/report"><i class="glyphicon glyphicon-inbox"></i> 汇总情况</a></li>
            <li><a href="${lx}/market/report/area"><i class="glyphicon glyphicon-star"></i> 购买区域</a></li>
            <li><a href="${lx}/market/report/purchase"><i class="glyphicon glyphicon-send"></i> 下单情况</a>
            </li>
            <li class="active"><a href="${lx}/market/report/payments"><i class="glyphicon glyphicon-pencil"></i> 付款情况</a></li>
            <li><a href="${lx}/market/report/shipservicelevel"><i class="glyphicon glyphicon-shopping-cart"></i>
                快递选择</a></li>
        </ul>
...
<script type="text/javascript">
    ...
    function init(startDate, endDate) {
        ...
        // ajax getting data
        $.ajax({
            "url": "${lx}/api/v1/market/report/payments/" + organizationId,
            "method": "POST",
            "data": {
                startDate: startDate,
                endDate: endDate
