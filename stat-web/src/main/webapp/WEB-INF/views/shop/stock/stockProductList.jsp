...
<%--产品修改modal--%>
<div id="stock_product" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="产品修改"
     aria-hidden="true">
  <div class="modal-dialog">
    <form id="stockProductForm" action="${lx}/stock/product/update" class="form-horizontal form-bordered"
          method="post">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="panel-body">
            ...
            <div class="form-group">
              <label class="col-sm-3 control-label">产品细类</label>
...
<script>
  jQuery(document).ready(function () {
    ...
    var inputTable = jQuery("#inputTable").bootstrapTable({
      "url": "${lx}/api/v1/stock/product/" + platformId,
      "method": "get",
      "striped": true,
      "sortOrder": "desc",
      "dataType": "json",
