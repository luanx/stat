...
<div class="tab-content">
    <div id="all" class="tab-pane active">
        ...
        <form id="inputForm" action="${lx}/logistics/issued" class="form-horizontal form-bordered">
        ...
        <div class="btn-group mr10">
            <a href="${lx}/logistics/issued" class="btn btn-default"><i class="fa fa-comments mr5"></i> 刷新</a>
        </div>
...
<script>
    jQuery(document).ready(function () {
        jQuery('#uploadExcel').fileupload({
            url: '${lx}/logistics/issued/upload',
            dataType: 'json',
            maxNumberOfFiles: 1,
            maxFileSize: 2000000,
