...
<div class="panel panel-default">
    ...
    <div class="panel-body panel-body-nopadding">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" id="purchaseDate" name="purchaseDate" value="<joda:format value="${order.purDate}" pattern="yyyy-MM-dd HH:mm:ss" />" class="form-control" disabled />
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" id="paymentsDate" name="paymentsDate" value="<joda:format value="${order.payDate}" pattern="yyyy-MM-dd HH:mm:ss" />" class="form-control" disabled/>
            </div>
        </div>
