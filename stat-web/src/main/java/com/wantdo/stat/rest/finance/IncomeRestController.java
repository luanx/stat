...
@RestController
@RequestMapping(value = "/api/v1/finance/income")
public class IncomeRestController {

    private static Logger logger = LoggerFactory.getLogger(IncomeRestController.class);
    ...
    public TableDTO<IncomeVo> getAllIncome(@RequestParam(value = "offset", defaultValue = "1") int offset,
        ...
        TableDTO<IncomeVo> incomes = incomeService.getIncomeVo(organizationId, searchParams, pageNumber, pageSize, sortType);
        if (incomes == null) {
            String message = "收入不存在";
            logger.warn(message);
