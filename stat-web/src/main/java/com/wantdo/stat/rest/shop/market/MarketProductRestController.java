...
@RestController
@RequestMapping(value = "/api/v1/market/product")
public class MarketProductRestController {

    private static Logger logger = LoggerFactory.getLogger(MarketProductRestController.class);
    ...
    public TableDTO<ProductVo> getAllProduct(@RequestParam(value = "offset", defaultValue = "1") int offset,
                                                           ...
                                                           @PathVariable("id") Long organizationId, Model model,
        ...
        TableDTO<ProductVo> products = productService.getProductVo(organizationId, searchParams, pageNumber, pageSize, sortType);
        if (products == null) {
