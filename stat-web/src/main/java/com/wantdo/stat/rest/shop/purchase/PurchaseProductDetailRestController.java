...
@RestController
@RequestMapping(value = "/api/v1/purchase/product_detail")
public class PurchaseProductDetailRestController {

    private static Logger logger = LoggerFactory.getLogger(PurchaseProductDetailRestController.class);
    ...
    public TableDTO<ProductDetailVo> getAllProduct(@RequestParam(value = "offset", defaultValue = "1") int offset,
        ...
        TableDTO<ProductDetailVo> productDetails = productService.getProductDetailVo(-1L, searchParams, pageNumber, pageSize, sortType);
    ...
    public TableDTO<ProductDetailVo> getAllProductById(@RequestParam(value = "offset", defaultValue = "1") int offset,
                                                           @RequestParam(value = "limit", defaultValue = PAGE_SIZE) int pageSize,
                                                           @RequestParam(value = "order", defaultValue = "auto") String sortType,
